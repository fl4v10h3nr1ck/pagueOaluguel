...
public final class Servidor {
	...
	protected String conecta( RegistroAtual auxRecord){
	...
	String key = null;	
		...
		HttpGet httpget = new HttpGet(PagueOAluguel.serverURL+"?ID="+auxRecord.getId()+"&accessKey2Server="+PagueOAluguel.accessKey2Server+"&softCOD="+auxRecord.getCodigo_sistema()+"&clientCOD="+auxRecord.getCodigo_cliente());
        ...
        if (entity != null)
        key = this.formataString(EntityUtils.toString(entity));
	...
	private String formataString(String key){
