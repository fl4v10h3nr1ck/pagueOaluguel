...
private JTextField tf_codSoft;
	...
	cons.weighty =0;
	cons.weightx = 1;
	this.lbDateInicial = new  JLabel("<html><b>Último Registro: </b>"+String.format("%02d", this.currentRecord.getInitialDay())+"/"+String.format("%02d", this.currentRecord.getInitialMonth())+"/"+String.format("%04d", this.currentRecord.getInitialYear())+"</html>");
	...
	backgroundPane.add(btGoBack, cons);	
		...
		btRegisterOffline.addActionListener( new ActionListener(){
			...
			lbDateInicial.setText("<html><b>Último Registro: </b>"+String.format("%02d", currentRecord.getInitialDay())+"/"+String.format("%02d", currentRecord.getInitialMonth())+"/"+String.format("%04d", currentRecord.getInitialYear())+"</html>");
	...
	private void getFinalDate(){
		...
		this.lbDateFinal.setText("<html><b>Licenciado até: </b>00/00/0000</html>");	
		return;
		}
	...
	SimpleDateFormat formatDate = new SimpleDateFormat("dd/MM/yyyy");  	
		...
		this.lbDateFinal.setText("<html><b>Licenciado até: </b>"+formatDate.format(calendar.getTime())+"</html>");	
		} 
